...
// Function to get the number of students who like neither vanilla nor butterscotch
...
int main() {
	...
	do {
		cout << "\nMenu:\n";
		cout << "1. Display set of students who like both vanilla and butterscotch\n";
		cout << "2. Display set of students who like either vanilla or butterscotch but not both\n";
		cout << "3. Display number of students who like neither vanilla nor butterscotch\n";
		cout << "4. Exit\n";
