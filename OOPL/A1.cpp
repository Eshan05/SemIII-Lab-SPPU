 ...
 * 1. Constructor (Including a default constructor which creates complex number
 * 0+0i)
...
class Complex {
 ...
 public:
  ...
  // We don't have two parameters as it is a member function (this object
  // applies)
...
int main() {
  ...
  do {
    ...
    switch(choice) {
      case 1:
        cout << "Enter complex number A (Format: a + b): ";
        cin >> a;
        break;
      case 2:
        cout << "Enter complex number B (Format: a + b): ";
        cin >> b;
        break;
      case 3: {
        Complex sum = a + b;
