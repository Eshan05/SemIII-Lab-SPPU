...
int main() {
  ...
  DDA line1(34, 170, 120, 20), line2(206, 170, 120, 20),
      line3(206, 170, 30, 170);
  circle1.drawCircle();
  circle2.drawCircle();
  line1.drawline();
  line2.drawline();
  ...
  DDA Line1(250, 300, 450, 300), Line2(450, 300, 450, 400),
      Line3(450, 400, 250, 400), Line4(250, 400, 250, 300);
  DDA Line5(350, 300, 450, 350), Line6(450, 350, 350, 400),
      Line7(350, 400, 250, 350), Line8(250, 350, 350, 300);
  Circle1.drawCircle();
  Line1.drawline();
  Line2.drawline();
  Line3.drawline();
